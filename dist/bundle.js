...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/base.js\");\n\nvar _control = __webpack_require__(/*! ./control */ \"./src/js/control.js\");\n\n//Show default images from Lorem Picsum\n_base.elements.defaultBtn.addEventListener('click', function () {\n  return (0, _control.showDefault)();\n});\n\n//Handle upload event\n_base.elements.uploadedImages.addEventListener('change', function (event) {\n  return (0, _control.uploadImages)(event);\n});\n\n//Anticlockwise rotation\n_base.elements.rotateAnticlock.addEventListener('click', function () {\n  return (0, _control.rotateImage)('anticlock');\n});\n\n//Clockwise rotation\n_base.elements.rotateClock.addEventListener('click', function () {\n  return (0, _control.rotateImage)('clock');\n});\n\n//Show the previous image\n_base.elements.previous.addEventListener('click', function () {\n  return (0, _control.changeImage)('p');\n});\n\n//Show the next image\n\n_base.elements.next.addEventListener('click', function () {\n  return (0, _control.changeImage)('n');\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
